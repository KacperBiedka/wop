    ...
    render() {
       ...
       return (
          <div className={"shadow p-3 mb-5 bg-white rounded " + classes.mainDiv}>
            ...
            <input value={this.state.repeatPassword} onChange={updateRepeatPasswordState}className={classes.inputField + " " + classes.passwordInput} type="password" placeholder="repeat password" />
            <button  onClick={createFirebaseUser} className={classes.authButton + " " + classes.loginButton}>
              Sign up
            </button>
            <Link to='/'>
